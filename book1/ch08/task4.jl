...
# ╔═╡ 4b4e6680-8b91-11ed-2fe8-37a07c964149
md"""# Task 4
...
the alphabet, wrapping around to the beginning if necessary, so ’A’ rotated by 3
is ’D’ and ’Z’ rotated by 1 is ’A’.

To rotate a word, rotate each letter by the same amount. For example, "cheer"
rotated by 7 is "jolly" and "melon" rotated by -10 is "cubed". In the movie
2001: A Space Odyssey, the ship computer is called HAL, which is IBM rotated by
-1.

Write a function called `rotateword` that takes a string and an integer as
parameters, and returns a new string that contains the letters from the original
string rotated by the given amount..
"""

# ╔═╡ 3616f034-5cfa-4341-a7cc-9e7b6cde0fc2
md"""## Solution"""

# ╔═╡ d2fe9c85-0e11-41f8-93a0-425602d15f8d
...
# ╔═╡ cec7cbc1-628c-40b4-8120-0b190deb616e
with_terminal() do
	words:: Vector{String} = ["cheer", "melon", "IBM", "Alan", "Alan", "Alan"]
	rotations:: Vector{Int} = [7, -10, -1, 26, 27, -27]
