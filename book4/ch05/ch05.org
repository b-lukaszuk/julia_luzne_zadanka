...
function getPosteriorLE(pmf::Pmf{T}, cutoffName::T)::Flt where T<:Union{Flt, Int}
    inds::Vec{Int} = findall((<=)(cutoffName), pmf.names)
    return sum(pmf.posteriors[inds])
end

function getPosteriorQuantile(pmf::Pmf{T}, prob::Flt)::Mfi where T<:Union{Flt, Int}
...
function getPosteriorCredibleInterval(pmf::Pmf{T}, prob::Flt)::Vec{Mfi} where T<:Union{Flt, Int}
...
fig = Cmk.Figure();
ax = Cmk.Axis(fig[1, 1],
              title="Prior distributions", xlabel="Number or trains", ylabel="PMF",
              xticks=0:250:1000, yticks=0:0.02:0.12);
Cmk.lines!(ax, trainPowerLawPriors.names, trainPowerLawPriors.priors, color=:orange, label="power law");
Cmk.lines!(ax, trainUniformPriors.names, trainUniformPriors.priors, color=:blue, label="uniform");
Cmk.axislegend();
fig
...
fig = Cmk.Figure();
ax = Cmk.Axis(fig[1, 1],
              title="Posterior distributions", xlabel="Number or trains", ylabel="PMF",
              xticks=0:250:1000, yticks=0:0.0025:0.0175);
Cmk.lines!(ax, trainPowerLawPriors.names, trainPowerLawPriors.posteriors, color=:orange, label="power law");
Cmk.lines!(ax, trainUniformPriors.names, trainUniformPriors.posteriors, color=:blue, label="uniform");
Cmk.axislegend();
fig
