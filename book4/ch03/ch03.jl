...
# ╔═╡ 66f9284b-a08f-457c-91e5-a8dba54ed535
md"""## Utilities"""
...
begin
	...
	function get_counts(v::Vector{String})::Dict{String, Int}
...
md"""### Probability Mass Functions"""

# ╔═╡ 6dfc9976-b851-447b-bb9b-5e8e8e446bcd
begin
	coin = mk_pmf_from_seq(["h", "t"])
	coin
end

# ╔═╡ 1eec0151-704e-4139-97df-90f718bd28ce
begin
	die = mk_pmf_from_seq(map(string, collect(1:6)))
	die
end
