...
Necesary condition: B1, B2 are: mutually exclusive and collectively exhaustive
...
after swapping $P(B{i}\ and\ A)$ to $P(A\ and\ B_{i})$ first (since conjunction/multiplication is commutative) gives us:

$P(A) + P(A\ and\ B_{1}) + P(A\ and\ B_{2})$
