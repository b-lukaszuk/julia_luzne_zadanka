...
function drawPriorsPosteriors(pmf::Pmf{<:Ufi}, title::Str,
    ...
    Cmk.lines!(ax, pmf.names, pmf.priors, label="prior")
    Cmk.lines!(ax, pmf.names, pmf.posteriors, label="posteriors")
    Cmk.axislegend();
    return fig
end
...
drawPriorsPosteriors(
    lecture, "Lecture hall", "number of people in the room", "PMF")
...
drawPriorsPosteriors(rabbits, "Rabbits in the garden with the camera phototrap",
