...
Cmk.lines!(ax, batting.names, batting.posteriors, label="posteriorr");
Cmk.axislegend();
fig
...
dataset = rep(['y', 'n'], [80-50, 20])
likelihood = Dict('y' => cheatingProbs, 'n' => 1 .- cheatingProbs)
...
Cmk.lines!(ax, taxes.names, taxes.posteriors, label="posteriorr");
Cmk.axislegend();
fig
