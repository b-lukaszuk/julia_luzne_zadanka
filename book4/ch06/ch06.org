...
d6 = getPmfFromSeq(c(1:6))
d6 = multDist(d6, d6)

d8 = getPmfFromSeq(c(1:8))
d8 = multDist(d8, d8)

d12 = getPmfFromSeq(c(1:12))
d12 = multDist(d12, d12)
...
twelves = Dict(
    6 => getPriorByName(d6, 12),
    8 => getPriorByName(d8, 12),
    12 => getPriorByName(d12, 12),
)
