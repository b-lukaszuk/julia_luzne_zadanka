...
# ╔═╡ f738b824-8df8-11ed-058b-45c6d70bf08d
md"""# Ch 3. Describing Data"""

# ╔═╡ bc0d8d77-06dd-477d-a3f7-a9936db81454
md"""### Imports"""
...
md"""## Data, functions, exploratory analysis, etc."""

# ╔═╡ 11b802a8-715b-453c-a092-00130f9ab709
md"""### Tab 3.1"""

# ╔═╡ 26d46378-cb8a-4930-a96c-a2353012d183
begin
	age::Vector{<:Number} = [7,7,8,8,8,9,11,12,12,13,13,14,14,15,16,17,17, 17,17,19,19,20,23,23,23]
	pi_max::Vector{<:Number} = [80, 85,110,95,95,100,45,95,130,75,80,70,80, 100,120,110,125,75,100,40,75,110,150,75,95]
	tab31 = pd.DataFrame((;age, pi_max))
end

# ╔═╡ 75a8a2da-f8f1-4073-a5a3-d1299de97375
pd.describe(tab31)

# ╔═╡ 41368a1d-59c1-4912-810c-d73bc40b171b
begin
...
# ╔═╡ 0bb3b8ff-6f3f-49f1-aa05-f2f31dd8573e
md"""### Tab 3.2"""

# ╔═╡ 671fe609-2b65-4f87-b803-47b66f66ab20
begin
	igm::Vector{<:Number} = vcat(collect(0.1:0.1:1.8), [2.0, 2.1, 2.2, 2.5, 2.7, 4.5])
	num_of_children::Vector{<:Number} = [3,7,19,27,32,35,38,38,22,16,16,6,7,9,6,2,3,3,3,2,1,1,1,1]
	tab32 = pd.DataFrame((;igm, num_of_children))
end
...
begin
	ages::Vector{<:Number} = [4,9,15,16,17,19,24,59,80] # there are
	# different width age groups e.g 0-4, 25-59, > 60
	# assumed upper limit is 80
	frequencies::Vector{<:Number} = [28,46,58,20,31,64,149,316,103]
end
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "eaa3b5e9f1d1a89ee733cd9f83133407e3db5589"
