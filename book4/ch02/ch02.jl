...
# ╔═╡ cceae031-a9a5-4a1d-b2bb-96f71da9e566
md"""### Exercise 4
...
# ╔═╡ 8ec7c9b8-c7a9-4753-867a-6188983b65cd
ex4 = pd.DataFrame(
	(; hypothesis_no=[1, 2],
	hypothesis_state=["bg1994_bg1996", "bg1996_bg1994"],
	# prior is P(H)
	prior=[1//2, 1//2],
	# likelihood is P(D|H), so I assume the hypothesis is true
	# y-g, y-g
	likelihood=[0.2*0.2, 0.14*0.1]
	)
)

# ╔═╡ 00e0ad77-b583-493a-88c6-f6197cf55c20
begin
	update!(ex4)
	ex4
end
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "32e2cf9b76e583411d9810123c21682ae43eea47"
