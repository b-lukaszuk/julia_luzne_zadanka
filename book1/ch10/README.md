...
Since I expected that the task is computationally expensive I limited myself to 7000 words. Still, it took about 15 secs to execute the code.

The result seems to be valid:
