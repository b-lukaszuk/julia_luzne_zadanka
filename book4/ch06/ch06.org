...
The term on the left is the ration of the posterior and prior odds. The term on
...
- P(D|A) - probability of finding blood groups O and AB, given it was Olivier
...
$\frac{odds(A|D)}{odds(A)} \approx 0.833$
